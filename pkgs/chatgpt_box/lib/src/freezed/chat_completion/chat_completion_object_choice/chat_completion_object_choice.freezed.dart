...
/// Adds pattern-matching-related methods to [ChatCompletionObjectChoice].
extension ChatCompletionObjectChoicePatterns on ChatCompletionObjectChoice {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChatCompletionObjectChoice value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChatCompletionObjectChoice() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChatCompletionObjectChoice value)  $default,){
final _that = this;
switch (_that) {
case _ChatCompletionObjectChoice():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChatCompletionObjectChoice value)?  $default,){
final _that = this;
switch (_that) {
case _ChatCompletionObjectChoice() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int index, @JsonKey(name: 'finish_reason')  String finishReason,  ChatCompletionObjectChoiceMessage message)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatCompletionObjectChoice() when $default != null:
return $default(_that.index,_that.finishReason,_that.message);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int index, @JsonKey(name: 'finish_reason')  String finishReason,  ChatCompletionObjectChoiceMessage message)  $default,) {final _that = this;
switch (_that) {
case _ChatCompletionObjectChoice():
return $default(_that.index,_that.finishReason,_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int index, @JsonKey(name: 'finish_reason')  String finishReason,  ChatCompletionObjectChoiceMessage message)?  $default,) {final _that = this;
switch (_that) {
case _ChatCompletionObjectChoice() when $default != null:
return $default(_that.index,_that.finishReason,_that.message);case _:
  return null;

...
/// Adds pattern-matching-related methods to [ChatCompletionObject].
extension ChatCompletionObjectPatterns on ChatCompletionObject {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChatCompletionObject value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChatCompletionObject() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChatCompletionObject value)  $default,){
final _that = this;
switch (_that) {
case _ChatCompletionObject():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChatCompletionObject value)?  $default,){
final _that = this;
switch (_that) {
case _ChatCompletionObject() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<ChatCompletionObjectChoice> choices,  int created,  String id,  String model,  String object, @JsonKey(name: 'system_fingerprint')  String systemFingerprint,  ChatCompletionObjectUsage usage, @JsonKey(name: 'service_tier')  String? serviceTier)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatCompletionObject() when $default != null:
return $default(_that.choices,_that.created,_that.id,_that.model,_that.object,_that.systemFingerprint,_that.usage,_that.serviceTier);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<ChatCompletionObjectChoice> choices,  int created,  String id,  String model,  String object, @JsonKey(name: 'system_fingerprint')  String systemFingerprint,  ChatCompletionObjectUsage usage, @JsonKey(name: 'service_tier')  String? serviceTier)  $default,) {final _that = this;
switch (_that) {
case _ChatCompletionObject():
return $default(_that.choices,_that.created,_that.id,_that.model,_that.object,_that.systemFingerprint,_that.usage,_that.serviceTier);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<ChatCompletionObjectChoice> choices,  int created,  String id,  String model,  String object, @JsonKey(name: 'system_fingerprint')  String systemFingerprint,  ChatCompletionObjectUsage usage, @JsonKey(name: 'service_tier')  String? serviceTier)?  $default,) {final _that = this;
switch (_that) {
case _ChatCompletionObject() when $default != null:
return $default(_that.choices,_that.created,_that.id,_that.model,_that.object,_that.systemFingerprint,_that.usage,_that.serviceTier);case _:
  return null;

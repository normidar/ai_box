...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ChatCompletionRequestMessage value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ChatCompletionRequestMessage() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ChatCompletionRequestMessage value)  $default,){
final _that = this;
switch (_that) {
case _ChatCompletionRequestMessage():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ChatCompletionRequestMessage value)?  $default,){
final _that = this;
switch (_that) {
case _ChatCompletionRequestMessage() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String role,  String content,  String? name,  String? refusal, @JsonKey(name: 'tool_call_id')  String? toolCallId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatCompletionRequestMessage() when $default != null:
return $default(_that.role,_that.content,_that.name,_that.refusal,_that.toolCallId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String role,  String content,  String? name,  String? refusal, @JsonKey(name: 'tool_call_id')  String? toolCallId)  $default,) {final _that = this;
switch (_that) {
case _ChatCompletionRequestMessage():
return $default(_that.role,_that.content,_that.name,_that.refusal,_that.toolCallId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String role,  String content,  String? name,  String? refusal, @JsonKey(name: 'tool_call_id')  String? toolCallId)?  $default,) {final _that = this;
switch (_that) {
case _ChatCompletionRequestMessage() when $default != null:
return $default(_that.role,_that.content,_that.name,_that.refusal,_that.toolCallId);case _:
  return null;

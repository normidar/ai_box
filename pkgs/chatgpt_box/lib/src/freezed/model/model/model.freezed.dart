...
mixin _$Model {
 ...
 String get id; String get object; int get created;@JsonKey(name: 'owned_by') String get ownedBy;
...
class _Model extends Model {
   _Model({required this.id, required this.object, required this.created, @JsonKey(name: 'owned_by') required this.ownedBy}): super._();
